...
export interface NativeInterface {
    ...
    addListener(eventName: EventListeners, listenerFunc: (...args: any[]) => void): Promise<PluginListenerHandle>;
}
...
export declare type EventListeners = 'pageLoaded' | 'updateDimensions' | 'updateScreenCapture' | 'navigationHandler' | 'pageLoadError';
export declare type ErrorCode = {
    errorCode: number;
};
export declare type PageLoadStatus = {
    isLoading: boolean;
};
